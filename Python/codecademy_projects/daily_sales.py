...
for x in thread_sold:
    if not "&" in x:
        ...
        y = x.split("&")
        thread_sold_split.append(y[0])
        thread_sold_split.append(y[1])
...
msg = " From color {} we sold {} pieces"
for c in colors:
    print(msg.format(c, color_count(c)))
